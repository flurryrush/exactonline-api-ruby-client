...
module Elmas
  ...
  class MaterialReversal
    ...
    def base_path
      "manufacturing/MaterialReversals"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ManufacturingMaterialReversals
    def other_attributes
      %i[
        reversal_stock_transaction_id batch_numbers created_by created_by_full_name created_date
        is_backflush is_batch is_fraction_allowed_item is_serial item item_code item_description
        item_picture_url note quantity serial_numbers shop_order shop_order_material_plan
