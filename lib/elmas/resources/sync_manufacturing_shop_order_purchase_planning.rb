...
module Elmas
  # Endpoint
  # SyncManufacturingShopOrderPurchasePlanning
  #
  # Good to know
  # Any change in the ShopOrderPurchasePlanning will lead to a new timestamp value.
  ...
  class SyncManufacturingShopOrderPurchasePlanning
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingShopOrderPurchasePlanning
    def other_attributes
      %i[
        timestamp created creator creator_full_name division factor factor_type modified modifier
        modifier_full_name purchase_order purchase_order_number quantity shop_order
        shop_order_material_plan shop_order_number shop_order_routing_step_plan
      ]
    end
  end
end
