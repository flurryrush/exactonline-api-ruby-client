...
module Elmas
  ...
  # g.
  #  Open, Processed) or when is the payment due.
  # 
  ...
  # Account, AccountBankAccountID, AccountContact, BankAccountID, Document, EndDate, EntryDate, EntryID, GLAccount, ID, InvoiceDate, InvoiceNumber, Source, Status, TransactionID, TransactionType
  # 
  # 
  #
  # Scope
  # Financial cashflow
  class BulkCashflowPayment
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=BulkCashflowPayments
