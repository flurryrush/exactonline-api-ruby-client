...
module Elmas
  # Endpoint
  # SyncManufacturingShopOrderSubOrder
  #
  # Good to know
  # Any change in the ShopOrderSubOrders will lead to a new timestamp value.
  ...
  class SyncManufacturingShopOrderSubOrder
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingShopOrderSubOrders
    def other_attributes
      %i[
        timestamp created creator creator_full_name division level modified modifier
        modifier_full_name shop_order shop_order_main shop_order_main_number
        shop_order_material_plan shop_order_number shop_order_parent shop_order_parent_number
      ]
    end
  end
end
