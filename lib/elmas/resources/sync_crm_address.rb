...
module Elmas
  ...
  class SyncCRMAddress
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncCRMAddresses
    def other_attributes
      %i[
        timestamp account account_is_supplier account_name address_line1 address_line2
        address_line3 city contact contact_name country country_name created creator
        creator_full_name custom_field division fax free_bool_field_01 free_bool_field_02
        ...
        free_number_field_05 free_text_field_01 free_text_field_02 free_text_field_03
        free_text_field_04 free_text_field_05 mailbox main modified modifier modifier_full_name
        nic_number notes phone phone_extension postcode source state state_description type
