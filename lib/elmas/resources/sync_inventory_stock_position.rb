...
module Elmas
  # Endpoint
  # SyncInventoryStockPosition
  #
  # Good to know
  # Any change in stock movement including stock count, purchase order, goods receipt, sales order, goods delivery, assembly order and warehouse transfer will lead to a new timestamp value in stock position.
  #  The API will return all stock movements data in the API call.
  #  Filtering will be only allowed for property Timestamp.
  # 
  ...
  class SyncInventoryStockPosition
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncInventoryStockPositions
    def other_attributes
      %i[
        timestamp current_stock division free_stock item_code item_description item_id planning_in
        planning_out projected_stock reorder_point reserved_stock unit_code unit_description
