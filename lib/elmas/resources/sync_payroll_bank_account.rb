...
module Elmas
  ...
  class SyncPayrollBankAccount
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollBankAccounts
    def other_attributes
      %i[
        timestamp bank_account_holder_name bic_code created creator creator_full_name description
        employee_full_name employee_hid main modified modifier modifier_full_name
      ]
    end
  end
end
