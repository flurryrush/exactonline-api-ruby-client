...
module Elmas
  ...
  # 
  # The API has two important key fields, the Timestamp and the EntryID.
  #  The EntryID should be used to uniquely identify the record and will never change
  # .
  ...
  # Scope
  # Sales contracts
  class SyncSubscriptionSubscription
    ...
    def mandatory_attributes
      %i[
        ordered_by subscription_type
      ]
    end

    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncSubscriptionSubscriptions
    def other_attributes
      %i[
        timestamp block_entry cancellation_date classification classification_code
        classification_description created creator creator_full_name currency customer_po_number
        description division end_date entry_id invoice_day invoiced_to invoice_to
        invoice_to_contact_person invoice_to_contact_person_full_name invoice_to_name
        invoicing_start_date modified modifier modifier_full_name notes number
        ordered_by_contact_person ordered_by_contact_person_full_name ordered_by_name
        payment_condition payment_condition_description printed project reason_cancelled
        reason_cancelled_code reason_cancelled_description start_date subscription_type_code
