...
module Elmas
  # Endpoint
  # SyncManufacturingShopOrderMaterialPlan
  #
  # Good to know
  # Any change in the ShopOrderMaterialPlans will lead to a new timestamp value.
  ...
  class SyncManufacturingShopOrderMaterialPlan
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingShopOrderMaterialPlans
    def other_attributes
      %i[
        timestamp backflush barcode calculator_type created creator creator_full_name description
        detail_drawing division item_code item_description item_material item_picture_url
        line_number modified modifier modifier_full_name notes planned_amount_fc planned_date
        planned_price_fc planned_quantity planned_quantity_factor routing_step_id status
        status_description type unit unit_description waste_percentage
      ]
    end
  end
end
