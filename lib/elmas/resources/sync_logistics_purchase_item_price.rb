...
module Elmas
  # Endpoint
  # SyncLogisticsPurchaseItemPrice
  #
  # Good to know
  ...
  # Scope
  # Purchase prices
  class SyncLogisticsPurchaseItemPrice
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncLogisticsPurchaseItemPrices
    def other_attributes
      %i[
        timestamp account account_name barcode created creator creator_full_name currency
        default_item_unit default_item_unit_description division end_date item item_code
        item_description modified modifier modifier_full_name number_of_items_per_unit price
        quantity start_date unit unit_description
      ]
    end
  end
end
