...
module Elmas
  # Endpoint
  # SyncInventoryItemStorageLocation
  #
  # Good to know
  ...
  # Scope
  # Logistics inventory
  class SyncInventoryItemStorageLocation
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncInventoryItemStorageLocations
    def other_attributes
      %i[
        timestamp created creator creator_full_name division item_code item_description
        maximum_stock minimum_stock modified modifier modifier_full_name storage_location
        storage_location_code storage_location_description type warehouse_code
