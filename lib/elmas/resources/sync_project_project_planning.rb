...
module Elmas
  ...
  #
  # Good to know
  # The ProjectPlanning sync api returns planning for Planned and Reserved.
  #  To filter out Planned and Reserved you need to filter only on property Status.
  ...
  # Scope
  # Projects projects
  class SyncProjectProjectPlanning
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncProjectProjectPlanning
    def other_attributes
      %i[
        timestamp account account_code account_name bgt_status communication_error_status created
        creator creator_full_name custom_field division employee_code employee_hid hours
        hour_type_code hour_type_description is_broken_recurrence modified modifier
        modifier_full_name notes over_allocate project project_code project_description
        project_planning_recurring project_wbs project_wbs_description type
      ]
    end
  end
end
