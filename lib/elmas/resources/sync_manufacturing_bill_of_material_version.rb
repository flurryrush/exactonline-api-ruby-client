...
module Elmas
  # Endpoint
  # SyncManufacturingBillOfMaterialVersion
  #
  # Good to know
  # Any change in the BillOfMaterialVersions will lead to a new timestamp value.
  ...
  class SyncManufacturingBillOfMaterialVersion
    ...
    def mandatory_attributes
      %i[
        description item order_lead_days
      ]
    end

    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingBillOfMaterialVersions
    def other_attributes
      %i[
        timestamp batch_quantity cad_drawing_url calculated_cost_price created creator
        creator_full_name division is_default item_description modified modifier modifier_full_name
        notes production_lead_days status status_description type type_description version_date
        version_number
      ]
    end
  end
