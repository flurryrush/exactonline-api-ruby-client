...
module Elmas
  ...
  class SyncHRMSchedule
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncHRMSchedules
    def other_attributes
      %i[
        timestamp billability_target code created creator creator_full_name days description
        division employment_hid end_date hours leave_hours_compensation main modified modifier
        modifier_full_name payment_parttime_factor schedule_type_description start_week
      ]
    end
  end
end
