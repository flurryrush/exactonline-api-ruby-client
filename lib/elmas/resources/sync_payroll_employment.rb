...
module Elmas
  ...
  class SyncPayrollEmployment
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmployments
    def other_attributes
      %i[
        timestamp created creator creator_full_name division employee employee_full_name
        employee_hid employment_number end_date modified modifier modifier_full_name reason_end
