...
module Elmas
  ...
  #
  # Good to know
  # Use this endpoint to get an overview of all your customers outstanding items amount in a specific age group.
  ...
  class AgingReceivablesListByAgeGroup
    ...
    def base_path
      "read/financial/AgingReceivablesListByAgeGroup"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ReadFinancialAgingReceivablesListByAgeGroup
