...
module Elmas
  ...
  class SyncHRMScheduleEntry
    ...
    def base_path
      "sync/HRM/ScheduleEntries"
    end

    def mandatory_attributes
      %i[
        day schedule week_number
      ]
    end

    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncHRMScheduleEntries
    def other_attributes
      %i[
        timestamp break break_end_time break_start_time created creator creator_full_name
        day_is_selected division employee employee_full_name employment employment_number end_time
        hours modified modifier modifier_full_name schedule_activity_type schedule_type start_time
      ]
    end
  end
end
