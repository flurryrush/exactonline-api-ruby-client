...
module Elmas
  ...
  # Scope
  # Sales prices
  class SyncLogisticsSalesItemPrice
    ...
    def base_path
      "sync/Logistics/SalesItemPrices"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncLogisticsSalesItemPrices
    def other_attributes
      %i[
        timestamp account account_name barcode created creator creator_full_name currency
        default_item_unit default_item_unit_description division employee end_date item item_code
        item_description modified modifier modifier_full_name number_of_items_per_unit price
        project project_description quantity start_date unit unit_description
      ]
    end
  end
end
