...
module Elmas
  ...
  # Scope
  # Hrm payroll
  class SyncPayrollEmploymentCLA
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmploymentCLAs
    def other_attributes
      %i[
        timestamp created creator creator_full_name division employee employee_full_name
        employee_hid employment employment_number end_date modified modifier modifier_full_name
        payroll_component_group payroll_component_group_description start_date
      ]
    end
  end
end
