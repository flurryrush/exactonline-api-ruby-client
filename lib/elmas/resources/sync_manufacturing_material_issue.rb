...
module Elmas
  # Endpoint
  # SyncManufacturingMaterialIssue
  #
  # Good to know
  # Any change in the MaterialIssues will lead to a new timestamp value.
  ...
  class SyncManufacturingMaterialIssue
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingMaterialIssues
    def other_attributes
      %i[
        timestamp created_by created_by_full_name created_date draft_stock_transaction_id
        has_reversible_quantity is_backflush is_batch is_fraction_allowed_item is_issue_from_child
        is_serial item item_code item_description item_picture_url note related_stock_transaction
        shop_order shop_order_number stock_transaction_id storage_location storage_location_code
