...
module Elmas
  ...
  # g.
  #  Open, Processed) or when is the collection is due.
  # 
  ...
  # Account, Document, EndDate, EndToEndID, EntryDate, EntryID, GLAccount, ID, InvoiceDate, InvoiceNumber, Source, Status, TransactionID, TransactionType
  # 
  # 
  #
  # Scope
  # Financial receivables
  class BulkCashflowReceivable
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=BulkCashflowReceivables
