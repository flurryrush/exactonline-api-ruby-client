...
module Elmas
  # Endpoint
  # SyncSalesOrderGoodsDeliveryLine
  #
  # Good to know
  ...
  # Scope
  # Logistics wms
  class SyncSalesOrderGoodsDeliveryLine
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncSalesOrderGoodsDeliveryLines
    def other_attributes
      %i[
        timestamp batch_numbers created creator creator_full_name customer_item_code delivery_date
