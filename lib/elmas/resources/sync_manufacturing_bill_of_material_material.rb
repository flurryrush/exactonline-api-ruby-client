...
module Elmas
  # Endpoint
  # SyncManufacturingBillOfMaterialMaterial
  #
  # Good to know
  # Any change in the BillOfMaterialMaterials will lead to a new timestamp value.
  ...
  class SyncManufacturingBillOfMaterialMaterial
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingBillOfMaterialMaterials
    def other_attributes
      %i[
        timestamp backflush calculator_type cost_batch cost_center cost_center_description
