...
module Elmas
  # Endpoint
  # SyncInventorySerialBatchNumber
  #
  # Good to know
  ...
  # Scope
  # Logistics items
  class SyncInventorySerialBatchNumber
    ...
    def base_path
      "sync/Inventory/SerialBatchNumbers"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncInventorySerialBatchNumbers
    def other_attributes
      %i[
        timestamp created creator creator_full_name division end_date is_blocked item item_code
        item_description modified modifier modifier_full_name remarks serial_batch_number
        start_date type
      ]
    end
  end
