...
module Elmas
  # Endpoint
  # SyncInventoryStockSerialBatchNumber
  #
  # Good to know
  ...
  class SyncInventoryStockSerialBatchNumber
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncInventoryStockSerialBatchNumbers
    def other_attributes
      %i[
        timestamp created creator creator_full_name division draft_stock_transaction_location
        draft_transaction_id is_draft item item_code item_description modified modifier
        modifier_full_name parent_id picklist_line pick_order_line purchase_transaction quantity
        remarks sales_order_line sales_return_line sales_transaction serial_batch_number
        stock_count_line stock_transaction_id stock_transaction_location storage_location
        storage_location_code storage_location_description warehouse warehouse_code
        warehouse_description warehouse_transfer_line
      ]
    end
  end
end
