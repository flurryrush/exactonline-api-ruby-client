...
module Elmas
  # Endpoint
  # SyncInventoryStorageLocationStockPosition
  #
  # Good to know
  ...
  # Scope
  # Logistics inventory
  class SyncInventoryStorageLocationStockPosition
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncInventoryStorageLocationStockPositions
    def other_attributes
      %i[
        timestamp division item item_code item_description quantity_to_picked reserved_pick
        serial_batch_reserved_stock stock storage_location storage_location_code
        storage_location_description unit_code unit_description warehouse warehouse_code
