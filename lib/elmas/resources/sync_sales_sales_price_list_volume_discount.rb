...
module Elmas
  # Endpoint
  # SyncSalesSalesPriceListVolumeDiscount
  #
  # Good to know
  ...
  # Scope
  # Sales prices
  class SyncSalesSalesPriceListVolumeDiscount
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncSalesSalesPriceListVolumeDiscounts
    def other_attributes
      %i[
        timestamp base_price base_price_amount created creator creator_full_name discount division
