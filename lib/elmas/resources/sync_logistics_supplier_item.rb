...
module Elmas
  ...
  # Scope
  # Logistics items
  class SyncLogisticsSupplierItem
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncLogisticsSupplierItem
    def other_attributes
      %i[
        timestamp barcode copy_remarks country_of_origin country_of_origin_description created
        creator creator_full_name currency currency_description division drop_shipment end_date
        item_code item_description item_unit_code item_unit_description main_supplier
        minimum_quantity modified modifier modifier_full_name notes purchase_lead_time
        purchase_lot_size purchase_unit_description purchase_unit_factor purchase_vat_code
