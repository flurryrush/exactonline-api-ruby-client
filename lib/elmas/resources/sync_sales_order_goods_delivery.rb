...
module Elmas
  ...
  # Scope
  # Logistics wms
  class SyncSalesOrderGoodsDelivery
    ...
    def base_path
      "sync/SalesOrder/GoodsDeliveries"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncSalesOrderGoodsDeliveries
    def other_attributes
      %i[
        timestamp created creator creator_full_name delivery_account delivery_account_code
        delivery_account_name delivery_address delivery_contact delivery_contact_person_full_name
        delivery_number description division document document_subject entry_id entry_number
        modified modifier modifier_full_name remarks shipping_method shipping_method_code
