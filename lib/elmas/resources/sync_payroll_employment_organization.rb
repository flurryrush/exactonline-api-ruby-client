...
module Elmas
  # Endpoint
  # SyncPayrollEmploymentOrganization
  #
  # Good to know
  ...
  # Scope
  # Hrm payroll
  class SyncPayrollEmploymentOrganization
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmploymentOrganizations
    def other_attributes
      %i[
        timestamp cost_center cost_center_description cost_unit cost_unit_description created
        creator creator_full_name department_code department_description division employee
        employee_full_name employee_hid employment_number end_date job_title_code
        job_title_description modified modifier modifier_full_name start_date
      ]
    end
  end
end
