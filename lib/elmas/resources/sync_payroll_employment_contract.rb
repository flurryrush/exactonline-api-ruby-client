...
module Elmas
  ...
  # Scope
  # Hrm payroll
  class SyncPayrollEmploymentContract
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmploymentContracts
    def other_attributes
      %i[
        timestamp contract_flex_phase contract_flex_phase_description created creator
        creator_full_name division document employee employee_full_name employee_hid employee_type
        employee_type_description employment_number end_date modified modifier modifier_full_name
