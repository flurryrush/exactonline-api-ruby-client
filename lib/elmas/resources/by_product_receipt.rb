...
module Elmas
  ...
  #  Use StockTransactionType of '147' when reserving these batch or serial numbers
  #
  # Scope
  ...
  class ByProductReceipt
    ...
    def base_path
      "manufacturing/ByProductReceipts"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ManufacturingByProductReceipts
    def other_attributes
      %i[
        ...
        shop_order shop_order_number storage_location storage_location_code
