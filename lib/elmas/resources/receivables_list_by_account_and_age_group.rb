...
module Elmas
  ...
  #
  # Good to know
  # Use this endpoint to get a specific customers payment terms information that falls under a specific age group.
  ...
  class ReceivablesListByAccountAndAgeGroup
    ...
    def base_path
      "read/financial/ReceivablesListByAccountAndAgeGroup"
    end
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ReadFinancialReceivablesListByAccountAndAgeGroup
