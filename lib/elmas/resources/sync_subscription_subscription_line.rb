...
module Elmas
  # Endpoint
  # SyncSubscriptionSubscriptionLine
  #
  # Good to know
  # The API will return both one time and recurring line type for subscription lines, to determined line type of the subscription line, the LineType property can be used.
  #  If the LineType is 1, the subscription line is recurring line.
  #  If the LineType is 2, the subscription line is one time line.
  #  
  ...
  # Scope
  # Sales contracts
  class SyncSubscriptionSubscriptionLine
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncSubscriptionSubscriptionLines
    def other_attributes
      %i[
        timestamp amount_dc amount_fc costcenter costunit custom_field description discount
        division from_date item_description line_number line_type line_type_description modified
        net_price notes quantity subscription_number to_date unit_code unit_description unit_price
