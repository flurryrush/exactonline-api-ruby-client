...
module Elmas
  # Endpoint
  # SyncPayrollEmploymentTaxAuthoritiesGeneral
  #
  # Good to know
  ...
  # Scope
  # Hrm payroll
  class SyncPayrollEmploymentTaxAuthoritiesGeneral
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmploymentTaxAuthoritiesGeneral
    def other_attributes
      %i[
        timestamp account created creator creator_full_name division employee employee_full_name
        employee_hid employment employment_number end_date influence_insurance_obligation
        influence_insurance_obligation_description modified modifier modifier_full_name
        nature_of_work_relationship nature_of_work_relationship_description payroll_taxes_number
        start_date type_of_income type_of_income_description
      ]
    end
  end
end
