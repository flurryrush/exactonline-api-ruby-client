...
module Elmas
  ...
  # Scope
  # Hrm payroll
  class SyncPayrollEmploymentSalary
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncPayrollEmploymentSalaries
    def other_attributes
      %i[
        timestamp amount_type amount_type_description average_days_per_week average_hours_per_week
        billability_target created creator creator_full_name description division employee
        employee_full_name employee_hid employment employment_number employment_salary_type
        employment_salary_type_description end_date external_rate frequency frequency_description
        fulltime_amount hourly_wage intercompany_rate internal_rate job_level modified modifier
        modifier_full_name parttime_amount parttime_factor salary_based_type
        salary_based_type_description scale schedule schedule_code schedule_description start_date
        wage_scale wage_scale_period wage_scale_step
      ]
    end
  end
end
