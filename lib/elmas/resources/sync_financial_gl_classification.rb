...
module Elmas
  ...
  # 
  # Note: This endpoint does not support query { $select=* }.
  #  Please query with a selection of one or more of the resource properties.
  # 
  # 
  #
  # Scope
  # Financial generalledgers
  class SyncFinancialGLClassification
    ...
    # https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncFinancialGLClassifications
    def other_attributes
      %i[
        timestamp abstract balance code created creator creator_full_name description division
