...
describe Elmas::ProjectTimeTransaction do
  it "can initialize" do
    project = Elmas::ProjectTimeTransaction.new
    expect(project).to be_a(Elmas::ProjectTimeTransaction)
  end
  ...
  it "returns value for getters" do
    project = Elmas::ProjectTimeTransaction.new({ "notes" => "Urenbundel 30 uur" })
    expect(project.notes).to eq "Urenbundel 30 uur"
  end

  it "crashes and burns when getting an unset attribute" do
    project = Elmas::ProjectTimeTransaction.new({ item: "eb73942a-53c0-4ee9-bbb2-6d985814a1b1" })
    expect(project.try(:item)).to eq nil
  end

  context "Applying filters" do
    it "should apply ID filter for find" do
      resource = Elmas::ProjectTimeTransaction.new(id: "12abcdef-1234-1234-1234-123456abcdef")
      expect(Elmas).to receive(:get).with("project/TimeTransactions(guid'12abcdef-1234-1234-1234-123456abcdef')?")
      resource.find
    end

    it "should apply no filters for find_all" do
      resource = Elmas::ProjectTimeTransaction.new(id: "12abcdef-1234-1234-1234-123456abcdef", item: "eb73942a-53c0-4ee9-bbb2-6d985814a1b1")
