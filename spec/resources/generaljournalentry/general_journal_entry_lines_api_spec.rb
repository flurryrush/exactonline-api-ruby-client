...
describe Elmas::GeneralJournalEntryLine do
  ...
  it "accepts attribute setter" do
    general_journal_entry_line = Elmas::GeneralJournalEntryLine.new
    general_journal_entry_line.document_number = "78238"
    expect(general_journal_entry_line.document_number).to eq "78238"
  end
  ...
  it "is valid with mandatory attributes" do
    general_journal_entry_line = Elmas::GeneralJournalEntryLine.new(entry_id: "23299ask-2233", gl_account: "sdjkj29")
